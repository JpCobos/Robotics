...
void write__tf2_msgs__msg__TFMessage(const tf2_msgs::msg::TFMessage& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__tf2_msgs__msg__TFMessage(int stack, tf2_msgs::msg::TFMessage *msg, const ROS2ReadOptions *opt = NULL);
