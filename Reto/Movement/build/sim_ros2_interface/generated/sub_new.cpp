    ...
    else if(in->topicType == "tf2_msgs/msg/TFMessage")
    {
        auto cb = [=](const tf2_msgs::msg::TFMessage::SharedPtr msg) { ros_callback__tf2_msgs__msg__TFMessage(msg, subscriptionProxy); };
        subscriptionProxy->subscription = node->create_subscription<tf2_msgs::msg::TFMessage>(in->topicName, get_qos(in->qos), cb);
    }
