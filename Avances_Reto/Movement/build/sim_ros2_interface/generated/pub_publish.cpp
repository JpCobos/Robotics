    ...
    else if(publisherProxy->topicType == "tf2_msgs/msg/TFMessage")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<tf2_msgs::msg::TFMessage> > >(publisherProxy->publisher);
        tf2_msgs::msg::TFMessage msg;
        read__tf2_msgs__msg__TFMessage(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
